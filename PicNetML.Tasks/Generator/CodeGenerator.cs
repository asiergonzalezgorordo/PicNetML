...
{
	[TestFixture, Ignore("Run Manually")]
	public class CodeGenerator
	{
		...
		[Test]
		public void GenerateCoreClassWrappers()
		{
			string dir = PrepDir("Generated");
		...
		[Test]
		public void GenerateAttributeSelectionEvaluators()
		{
			string dir = PrepDir(@"AttrSel\Evals\Generated");

			Type[] types = GetBaseClassesOf(typeof(ASEvaluation)).
					ToArray();
		...
		[Test]
		public void GenerateAttributeSelectionAlgorithms()
		{
			string dir = PrepDir(@"AttrSel\Algs\Generated");

			Type[] types = GetBaseClassesOf(typeof(ASSearch));
			Array.ForEach(types, t =>
		...
		[Test]
		public void GenerateClusterers()
		{
			string dir = PrepDir(@"Clstr\Generated");

			Type[] types = GetBaseClassesOf(typeof(AbstractClusterer));
			Array.ForEach(types, t =>
		...
		[Test]
		public void GenerateAllFilters()
		{
			string dir = PrepDir(@"Fltr\Generated");

			Type[] types = GetBaseClassesOf(typeof(Filter));
		...
		[Test]
		public void GenerateAllClassifiers()
		{
			string dir = PrepDir(@"Clss\Generated");

			Type[] types = GetBaseClassesOf(typeof(Classifier));
			List<string> namespaces = types.
					Select(t => t.Namespace).
					Distinct().
					ToList();
		...
		[Test]
		public void GenerateAllAssociations()
		{
			string dir = PrepDir(@"Asstn\Generated");

			Type[] types = GetBaseClassesOf(typeof(AbstractAssociator));
			Array.ForEach(types, t =>
		...
		{
			IPmlCodeGenerator eval = (IPmlCodeGenerator)Activator.CreateInstance(template, t);
		...
		{
			string output = @"..\..\..\PicNetML\" + file + ".cs";
			if (File.Exists(output))
			{
				File.Delete(output);
			}

			string generated = eval.TransformText();
