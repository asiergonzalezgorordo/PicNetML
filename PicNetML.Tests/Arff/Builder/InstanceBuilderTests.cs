...
namespace PicNetML.Tests.Arff.Builder
{
	...
	public class InstanceBuilderTests
	{
		internal class TestingRow
		{
			...
			[Nominal, Binarize] public int ATT_1 { get; set; }
			[Nominal, Binarize] public int ATT_2 { get; set; }
			[Nominal, Binarize] public int ATT_3 { get; set; }
			[Nominal, Binarize] public int ATT_4 { get; set; }
			[Nominal, Binarize] public int ATT_5 { get; set; }
			[Nominal, Binarize] public int ATT_6 { get; set; }
			[Nominal, Binarize] public int ATT_7 { get; set; }
			[Nominal, Binarize] public int ATT_8 { get; set; }
		}
		...
		[Test]
		public void test_grouping_when_less_than_2()
		{
			TestingRow2[] rows = new[] {
			...
			weka.core.Instances instances = new InstancesBuilder<TestingRow2>(rows, 0).Build();
		...
		[Test]
		public void test_grouping_when_less_than_3()
		{
			TestingRow2[] rows = new[] {
		...
		[Test]
		public void test_goruping_then_binarizing()
		{
			TestingRow3[] rows = new[] {
			...
			weka.core.Instances instances = new InstancesBuilder<TestingRow3>(rows, 0).Build();
		...
		[Test]
		public void test_goruping_with_max_bins()
		{
			TestingRow4[] rows = new[] {
			...
			weka.core.Instances instances = new InstancesBuilder<TestingRow4>(rows, 0).Build();
		...
		[Test]
		public void test_has_class_value()
		{
			...
			weka.core.Instances instances = new InstancesBuilder<TestingRow5>(rows, 0).Build();
		...
		[Test]
		public void test_has_class_value_is_remembered()
		{
			TestingRow5[] rows = new[] {
				new TestingRow5 { CLASS = 1.0, ATT_1 = "1" },
				new TestingRow5 { CLASS = 33.0, ATT_1 = "2" },
		...
		[Test]
		public void test_has_class_value_on_extendable()
		{
			TestingRow5[] rows = new[] {
				new TestingRow5 { CLASS = 1.0, ATT_1 = "1" },
				new TestingRow5 { CLASS = 33.0, ATT_1 = "2" },
			...
			System.Collections.Generic.IEnumerable<ExtendableObj<TestingRow5>> extendable = rows.Select(r => ExtendableObj.Create(r).AddNominal("added", "yes"));
			weka.core.Instances instances = new InstancesBuilder<ExtendableObj<TestingRow5>>(extendable.ToArray(), 0).Build();
